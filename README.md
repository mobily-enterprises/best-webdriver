...
Note that you are using the generic [Driver](https://mercmobily.github.io/best-webdriver/Driver.html), which means that no browser-specific workarounds for W3C compliance will be applied. If you did want that to happen, for example with Chrome, you would simply run:
